...
from models.swintransformer import SwinStage, PatchMerging, PatchEmbed, SwinCBAM, SwinBiCBAM
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                Conv, GhostConv, Bottleneck, SwinStage, SwinCBAM, SwinBiCBAM, RepConv, PatchMerging, PatchEmbed, GhostBottleneck, SPP, SPPF, DWConv, MixConv2d, Focus, CrossConv,
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, Multi_Concat_Block, Transition_Block, RepConv, DConv3, DConv5, C2f, CNBlock}:
            c1, c2 = ch[f], args[0]
