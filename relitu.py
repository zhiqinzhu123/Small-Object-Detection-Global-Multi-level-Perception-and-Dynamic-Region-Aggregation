...
def get_params():
    params = {
        'weight': 'runs/train/exp146/weights/best.pt',
        'cfg': 'models/CT5.yaml',
        'device': 'cuda:0',
        'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM 108 1 1146  105 2 85 5
        'layer': 'model.model[62]',
...
# def get_params1():
#     params = {
#         'weight': 'runs/train/exp85/weights/best.pt',
#         'cfg': 'models/CT5.yaml',
#         'device': 'cuda:0',
#         'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM 108 1 1146  105 2 85 5
#         'layer': 'model.model[-2]',
...
# def get_params2():
#     params = {
#         'weight': 'runs/train/exp114/weights/best.pt',
#         'cfg': 'models/CT6.yaml',
#         'device': 'cuda:0',
#         'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM 108 1 1146  105 2 85 5
#         'layer': 'model.model[-2]',
...
# def get_params3():
#     params = {
#         'weight': 'runs/train/exp105/weights/best.pt',
#         'cfg': 'models/CT2.yaml',
#         'device': 'cuda:0',
#         'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM 108 1 1146  105 2 85 5  155 ct5 no trans   146 no conv
#         'layer': 'model.model[-2]',
#         'backward_type': 'class',  # class or conf
#         'conf_threshold': 0.6,  # 0.6
#         'ratio': 0.02  # 0.02-0.1
...
if __name__ == '__main__':
    ...
    # model1 = yolov5_heatmap(**get_params1())
    # model2 = yolov5_heatmap(**get_params2())
    # model3 = yolov5_heatmap(**get_params3())
    model(r'C:\data\热力图\原图/2.jpg', 'result4')
    # model1(r'data/images/000360.jpg', 'result1')
    # model2(r'data/images/000360.jpg', 'result2')
    # model3(r'data/images/000360.jpg', 'result3')